        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
             ...
             //   int offset = (int) (deltaY * 0.48);
                int offset = (int) (deltaY * 1);
                mContentView.layout(mRect.left, mRect.top + offset, mRect.right, mRect.bottom + offset);
                Log.e(TAG,"move :   mContentView.getTop(): "+ mContentView.getTop()+"   mRect.top: "+mRect.top);
            ...
            case MotionEvent.ACTION_UP:
                if (!rebound) break;
                mOnReboundEndListener.onRelease();
                ...
                Log.e(TAG,"release :   mContentView.getTop(): "+mContentView.getTop()+"   mRect.top: "+mRect.top);
